...
wx5a5fd1f414647ee6',
  ...
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '4c50f85600beb3838739ef619e0c0296',
   ...
   */
  USERS: [odKrO6q-wblBu-RkolsVhUzvsLds,odKrO6glWztwrFIg-BaXEyXZYE9Y,odKrO6gT5v3VP6KJ6U3Eyil2AMBI
    {
      // 想要发送的人的名字
      name: '宝宝',
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'odKrO6q-wblBu-RkolsVhUzvsLds',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'Ua8cn_lG8pH-Y3zDOUusveO2NCNXRAC2F42NrdpSbj0',
      // 所在省份
      province: '甘肃',
      // 所在城市
      city: '兰州',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '宝宝', year: '1995', date: '12-31',
        },
        {
          type: '节日', name: '第一次加V', year: '2022', date: '08-12',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '爸爸', year: '1994', date: '10-30',
        },
        {
          type: '节日', name: '第一次见面', year: '2022', date: '08-14',
        }
      ],
